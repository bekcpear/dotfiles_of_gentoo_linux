...
temp_timer:connect_signal('timeout', function()
  ...
  while temper_c == '' or temper_c == nil do
    temper_c          = mytl.file_read('/sys/module/k10temp/drivers/pci:k10temp/0000:00:18.3/hwmon/hwmon' .. hwmon_num .. '/temp1_input', false)
  ...
  while temper1_c == '' or temper1_c == nil do
    temper1_c          = mytl.file_read('/sys/module/k10temp/drivers/pci:k10temp/0000:00:19.3/hwmon/hwmon' .. hwmon_num .. '/temp1_input', false)
    hwmon_num     = hwmon_num + 1
    if hwmon_num >= 10 then
