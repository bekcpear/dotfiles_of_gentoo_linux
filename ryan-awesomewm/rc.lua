...
beautiful.init("/home/ryan/.config/awesome/themes/my/theme.lua")
...
function openTerminal()
  ...
  if tagFirTers[ntag.index] ~= true then -- for konsole only
    mytl.s_easy_async("konsole --name 'tagFirTer'")
    tagFirTers[ntag.index] = true
  else
    mytl.s_easy_async("konsole")
  end
end
-- }}}
...
globalkeys = gears.table.join(
    ...
    --                                              awful.spawn("urxvt -name 'testUrxvt'", {
    --                                              tag = "5.S"
    --                                            })
    --                                         end,
    --        {description = "open a testing terminal", group = "launcher"}),
...
--          "Netease Music Box",
    ...
    { rule_any = {
      ...
      callback = function(c)
        c:geometry({
          x = awful.screen.focused().geometry['width'] / 2 - 500,
    ...
    { rule = { class = "kmag" },
      ...
      callback = function(c)
        c:geometry({x=0, y=20, width=800, height=600})
      end
    },
...
client.connect_signal("request::titlebars", function(c)
    ...
    if c.name and string.find(c.name, 'Cloud%sMusic$') ~= nil then -- for Netease Cloud Music Black Theme
      titlebarbg = "#222225"
    elseif c.class and c.class == 'Alacritty' or c.class == 'URxvt' or c.class == 'konsole' then
      titlebarbg = "#373737"
    ...
    elseif c.instance and string.find(c.instance, '^mail%.google%.com') ~= nil then
      titlebarbg = "#ffffff"
    elseif c.class and c.class == 'Chromium-browser-chromium' then
      titlebarbg = "#dee1e6"
